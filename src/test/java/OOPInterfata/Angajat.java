...
public interface Angajat {
    ...
    // Interfata contine doar metode abstracte (se defineste tipul metodei
    // fara sa contina BODY adica acolade)
    ...
    // Clasa care implementeaza interfata trebuie sa implementeze
    // toate metodele interfetei
